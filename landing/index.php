                    ...
                    <div class="col-lg-12 d-flex justify-content-around" style="flex-wrap:wrap;">
                        ...
                        ?>
                            ...
                            <div class="card mb-4" style="width: 18rem;">
                                ...
                                <div class="mb-3 mt-0">
                                    <a href="./client/room_details.php?room_id=<?php echo htmlspecialchars($row1->room_id); ?>"
                                        class="btn btn-primary btnAddCategory someText">Check More Details</a>
                                </div>
                            </div>
    ...
    <section id="aboutus" class="py-5">
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-6">
                    <img src="./client/dist/img/meeting.jpg" class="img-fluid rounded shadow" alt="Our Beginnings">
                </div>
                <div class="col-lg-6">
                    <h3 class="bigTitle mt-3">Our Beginnings</h3>
                    <p class="contentPara">
                        Luxe Haven started as a small boutique hotel catering to discerning guests seeking an intimate
                        and personalized stay. Over the years, our commitment to excellence earned us a reputation as
                        one of the most sought-after destinations for both leisure and business travelers.
                    </p>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-5 flex-lg-row-reverse">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="contentPara">
                        As our guests' trust and loyalty grew, so did our vision. Luxe Haven expanded its offerings,
                        introducing state-of-the-art facilities, luxurious suites, fine dining restaurants, and wellness
                        amenities. By 2015, we proudly became a premier destination for international travelers, hosting
                        memorable weddings, corporate events, and once-in-a-lifetime celebrations.
                    </p>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="contentPara">
                        At Luxe Haven, we believe in creating moments that matter. We combine modern elegance with
                        touches of traditional Filipino culture, showcasing the beauty of the Philippines while offering
                        unparalleled comfort. We strive to provide not just a stay, but an experience. Whether you're
                        here for a relaxing escape, a business trip, or a special occasion, Luxe Haven Hotel PH promises
                        exceptional service, luxurious accommodations, and unforgettable memories.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <form id="inquiryForm" action="send_inquiry.php" method="POST">
                            ...
                            <div class="mb-2 d-grid mt-3">
                                <button type="submit" name="send_inquiry"
                                    class="btn btn-primary btnAddCategory someText">Send Inquiry</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.querySelector(".btnAddCategory").addEventListener("click", function () {
                ...
                setTimeout(() => {
                    fetch("./client/check_availability.php", {
                        method: "POST",
...
<footer style="background-color: <?php echo $settings['site_primary_color']; ?>; color: white;">
    <div class="footer-container">
        ...
        <div class="footer-logo">
            <img src="./admin/dist/img/logos/<?php echo $settings['site_logo']; ?>"
        ...
        <div class="footer-contact">
            ...
            <p><i class="fas fa-envelope"></i> <a
                    href="mailto:<?php echo $settings['site_email']; ?>"><?php echo $settings['site_email']; ?></a></p>
            <p><i class="fas fa-phone"></i> <a
                    href="tel:<?php echo $settings['site_contact']; ?>"><?php echo $settings['site_contact']; ?></a></p>
        </div>
        ...
        <div class="footer-subscribe">
            ...
            <form action="./client/subscribe.php" method="POST">
...
<style>
    ...
    .footer-links ul li a:hover {
        color:
            <?php echo $settings['site_hover_color']; ?>
        ;
    }
    ...
    .footer-subscribe button {
        padding: 10px;
        background-color:
            <?php echo $settings['site_bg_color']; ?>
        ;
        color: black;
        border: none;
        border-radius: 5px;
