                    ...
                    <div class="col-lg-12 d-flex justify-content-around" style="flex-wrap:wrap;">
                        ...
                        while ($row1 = $res->fetch_object()) {
                            ...
                            <div class="card mb-4" style="width: 18rem;">
                                <img src="../admin/dist/img/<?php echo $row1->room_picture ?>" class="card-img-top"
                                ...
                                <div class="mb-3 mt-0">
                                    <a href="room_details.php?room_id=<?php echo $row1->room_id ?>"
                ...
                <div class="container">
                    <div class="col-lg-12 d-flex justify-content-around" style="flex-wrap:wrap;">
                        ...
                        while ($row1 = $res->fetch_object()) {
                            ...
                            <div class="card mb-4" style="width: 18rem;">
                                <img src="../admin/dist/img/<?php echo $row1->service_picture ?>" class="card-img-top"
                                    style="height: 180px;">
                                <div class="card-body">
