                    ...
                    <div class="col-lg-12 m-auto d-flex justify-content-center mt-5">
                        <div class="col-4 mt-5">
                            <div class="roomContainer">
                                <img src="../admin/dist/img/<?php echo $row1->room_picture ?>"
                        ...
                        <div class="col-4 p-4 mt-5">
                            ...
                            <hr class="mb-3">
                            <p class="someText">Note: Online booking payments are accepted via <strong>GCash</strong> only.
                            </p>
                            <p class="someText">Total Price: <strong>PHP
                                    <?php echo number_format($row1->room_price, 2); ?></strong></p>
                            <p class="someText">Down Payment (50%): <strong>PHP
                                    <?php echo number_format($half_price, 2); ?></strong></p>
                            <form id="bookingForm" method="POST" enctype="multipart/form-data">
                                <div class="col-4 mt-2 d-grid">
                                    ...
                                    <div class="mb-2 d-grid mt-3">
                                        <button type="button" name="proceedBtn" id="proceedBtn"
                                            class="btn btn-primary btnAddCategory someText">Confirm Booking</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <form id="paymentForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                <input type="text" name="gcash_name" class="form-control" placeholder="Your Gcash Name"
                                    required>
                            </div>
                            <div class="mb-2">
                                <input type="number" name="gcash_number" class="form-control"
                                    placeholder="Your Gcash Number" required>
                            </div>
                            <div class="mb-2">
                                <input type="number" name="gcash_ref" class="form-control" placeholder="Your Gcash Ref"
                                    required>
                            </div>
                            <div class="mb-3">
                                <input type="file" name="gcash_screenshot" class="form-control"
                                    placeholder="Your Gcash Screenshot" required>
                            </div>
